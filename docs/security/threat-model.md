...
| TM-06 | Repudiation                        | Operador nega inclusão, correção ou encerramento de registro                                                   |   3 |   3 |     9 | Usuário autenticado, ator persistido, justificativa, correlation ID e auditoria imutável suficiente — #29, #31, #47, #51, #53, #55, #57, #61, #65 e #271                                                                                                                    | Correção descritiva e encerramento excepcional auditados; correções institucionais e imutabilidade por privilégios pendentes                                                                                                           |
...
| TM-24 | Spoofing / Information disclosure   | Tablet compartilhado permanece autenticado sem operador e permite uso da sessão por outra pessoa               |   3 |   3 |     9 | Inatividade de 15 minutos, duração absoluta de 12 horas, prazos emitidos pelo servidor, logout explícito, coordenação entre abas e renovação condicionada a atividade humana — #268                                                                                           | Política e contrato do servidor implementados; integração do frontend e validação no tablet da portaria pendentes                                                                                                                     |
