...
namespace ControleAcessoVeiculos.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260924023616_AddExceptionalAccessClosure")]
    partial class AddExceptionalAccessClosure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.AutorizacaoVeiculoEvento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("EventoAcessoId")
                        .HasDatabaseName("ix_autorizacoes_veiculos_eventos_evento_id");

                    b.HasIndex("EventoAcessoId", "Placa")
                        .IsUnique()
                        .HasDatabaseName("ux_autorizacoes_veiculos_eventos_evento_placa")
                        .HasFilter("placa IS NOT NULL");

                    b.HasIndex("EventoAcessoId", "TipoVeiculo")
                        .IsUnique()
                        .HasDatabaseName("ux_autorizacoes_veiculos_eventos_evento_tipo_sem_placa")
                        .HasFilter("placa IS NULL");

                    b.ToTable("autorizacoes_veiculos_eventos", "dbo", t =>
                        {
                            t.HasCheckConstraint("ck_autorizacoes_veiculos_eventos_quantidade", "quantidade > 0 AND (placa IS NULL OR quantidade = 1)");
                        });
                });
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.EventoAcesso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<bool>("PermitePernoite")
                        .HasColumnType("boolean")
                    ...
                    b.ToTable("eventos_acesso", "dbo", t =>
                        {
                            t.HasCheckConstraint("ck_eventos_acesso_periodo", "fim > inicio");
                        });
                });

            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.MotoristaInstitucional", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("motoristas_institucionais", "dbo");
                });
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.RegistroAcesso", b =>
                {
                    ...
                    b.Property<int?>("AutorizacaoVeiculoEventoId")
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime?>("DataHoraRegularizacao")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("MotivoEncerramentoExcepcional")
                        .HasMaxLength(40)
                    ...
                    b.Property<string>("ObservacaoEncerramentoExcepcional")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                    ...
                    b.Property<string>("TipoEncerramento")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.HasIndex("AutorizacaoVeiculoEventoId")
                    ...
                    b.HasIndex("DataHoraEntrada")
                        .HasDatabaseName("ix_registros_acesso_data_entrada");

                    b.HasIndex("DataHoraRegularizacao")
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.SessaoAutenticacao", b =>
                {
                    ...
                    b.Property<string>("TokenSubstitutoHash")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasIndex("FamiliaId", "RevogadaEm")
                        .HasDatabaseName("ix_sessoes_autenticacao_familia_revogada_em");

                    b.HasIndex("UsuarioId", "ExpiraEm")
                        .HasDatabaseName("ix_sessoes_autenticacao_usuario_expira_em");

                    b.ToTable("sessoes_autenticacao", "dbo", t =>
                        {
                            t.HasCheckConstraint("ck_sessoes_autenticacao_motivo_revogacao", "motivo_revogacao IS NULL OR motivo_revogacao IN ('Rotacao', 'Logout', 'Expiracao', 'ContaDesativada', 'ReutilizacaoDetectada', 'SenhaAlterada', 'RedefinicaoAdministrativa')");

                            t.HasCheckConstraint("ck_sessoes_autenticacao_periodo", "expira_em > criada_em");

                            t.HasCheckConstraint("ck_sessoes_autenticacao_revogacao", "(revogada_em IS NULL AND motivo_revogacao IS NULL) OR (revogada_em IS NOT NULL AND motivo_revogacao IS NOT NULL)");

                            t.HasCheckConstraint("ck_sessoes_autenticacao_rotacao", "(consumida_em IS NULL AND token_substituto_hash IS NULL) OR (consumida_em IS NOT NULL AND token_substituto_hash IS NOT NULL AND motivo_revogacao = 'Rotacao')");

                            t.HasCheckConstraint("ck_sessoes_autenticacao_token_hash", "token_hash ~ '^[0-9a-f]{64}$'");

                            t.HasCheckConstraint("ck_sessoes_autenticacao_token_substituto_hash", "token_substituto_hash IS NULL OR token_substituto_hash ~ '^[0-9a-f]{64}$'");
                        });
                });
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.UsoVeiculoInstitucional", b =>
                {
                    ...
                    b.HasIndex("MotoristaId", "DataHoraSaida")
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime?>("CredencialTemporariaExpiraEm")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("credencial_temporaria_expira_em");

                    b.Property<DateTime?>("CredencialTemporariaUtilizadaEm")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.Veiculo", b =>
                {
                    ...
                    b.HasIndex("IdentificacaoVeiculo")
                        .IsUnique()
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.AutorizacaoVeiculoEvento", b =>
                {
                    b.HasOne("ControleAcessoVeiculos.Domain.Entities.EventoAcesso", null)
                        .WithMany()
                        .HasForeignKey("EventoAcessoId")
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.MotoristaInstitucional", b =>
                {
                    ...
                    b.HasOne("ControleAcessoVeiculos.Domain.Entities.Pessoa", null)
                        .WithOne()
                        .HasForeignKey("ControleAcessoVeiculos.Domain.Entities.MotoristaInstitucional", "PessoaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.RegistroAcesso", b =>
                {
                    ...
                    b.HasOne("ControleAcessoVeiculos.Domain.Entities.AutorizacaoVeiculoEvento", null)
                        .WithMany()
                        .HasForeignKey("AutorizacaoVeiculoEventoId")
                        .OnDelete(DeleteBehavior.Restrict)
