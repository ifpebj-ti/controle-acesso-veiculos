...
namespace ControleAcessoVeiculos.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260913185634_AddSecureAuthenticationSessions")]
    partial class AddSecureAuthenticationSessions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.SessaoAutenticacao", b =>
                {
                    ...
                    b.ToTable("sessoes_autenticacao", "dbo", t =>
                        {
                            t.HasCheckConstraint("ck_sessoes_autenticacao_motivo_revogacao", "motivo_revogacao IS NULL OR motivo_revogacao IN ('Rotacao', 'Logout', 'Expiracao', 'ContaDesativada', 'ReutilizacaoDetectada')");
