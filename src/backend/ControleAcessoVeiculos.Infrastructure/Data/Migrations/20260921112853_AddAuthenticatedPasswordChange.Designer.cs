...
namespace ControleAcessoVeiculos.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260921112853_AddAuthenticatedPasswordChange")]
    partial class AddAuthenticatedPasswordChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ControleAcessoVeiculos.Domain.Entities.SessaoAutenticacao", b =>
                {
                    ...
                    b.ToTable("sessoes_autenticacao", "dbo", t =>
                        {
                            t.HasCheckConstraint("ck_sessoes_autenticacao_motivo_revogacao", "motivo_revogacao IS NULL OR motivo_revogacao IN ('Rotacao', 'Logout', 'Expiracao', 'ContaDesativada', 'ReutilizacaoDetectada', 'SenhaAlterada')");
